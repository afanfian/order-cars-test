...
<div class="flex items-center justify-center h-screen">
    <form action="/cars/{{ $cars->id }}" method="POST" enctype="multipart/form-data" class="w-4/12 bg-white shadow-md rounded-lg p-8">
        @method('PUT')
        @csrf
        <p class="text-center text-xl font-bold pb-5">Edit Data Mobil</p>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="file" name="image" id="image" placeholder="Surabaya" value="{{ $cars->image }}" class="px-4 py-2 border rounded-lg w-full focus:outline-none focus:border-blue-500">
        </div>
